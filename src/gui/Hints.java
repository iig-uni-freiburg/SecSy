...
public class Hints {
	...
	public static final String hintFilterList =				"<html>Filters are applied in the order they appear in the list.<br>" +
															"Note, that filters may lock fields to ensure consistency and this may block" +
															"the appliance of succeeding filters.</html>";
	
	public static final String hintDayDelayFilter = 				"<html><font size=-2>A day delay filter adds an extra delay of several days<br>" +
																						"between events of a process trace. Filter parameterization<br>" +
	...
	public static final String hintSkipActivitiesFilter =			"<html><font size=-2>A skip activities filter removes single events from a<br>" +
																						"process trace. To simulate skipping, timestamps of<br>" +
																						"succeeding events are adjusted. Filter parameterization<br>" +
	...
	public static final String hintIncompleteLoggingFilter =		"<html><font size=-2>An incomplete logging filter removes single events<br>" +
																						"from a process trace. In contrast to the skip activities<br>" +
																						"filter, timestamps of succeeding events are NOT adjusted.<br>" +
																						"Filter parameterization allows to specify a set of<br>" +
	...
	public static final String hintUnauthorizedExecutionFilter =	"<html><font size=-2>An unauthorized execution filter changes single events of<br>" +
																						...
																						"The filter fails, if all originators are authorized<br>" +
																						"to execute all activities.</font></html>";
	
	public static final String hintObfuscationFilter =				"<html><font size=-2>An obfuscation filter removes values of specific fields<br>" +
																						"from events of a process trace. Filter parameterization<br>" +
	...
	public static final String hintSoDFilter =						"<html><font size=-2>This filter enforces or violates separation of duties<br>" +
																						...
																						"in the set.<br>" +
																						"Instead of an activation probability, the filter is<br>" +
																						"parameterized with a violation probability. A probability of<br>" +
																						"0 lets the filter enforce the property.<br><br>" +
																						"The filter fails, if originators cannot be chosen adequately.</font></html>";
	
	public static final String hintBoDFilter =						"<html><font size=-2>This filter enforces or violates binding of duties constraints<br>" +
																						...
																						"A probability of 0 lets the filter enforce the property.<br><br>" +
																						"The filter fails, if originators cannot be chosen adequately.</font></html>";
}
