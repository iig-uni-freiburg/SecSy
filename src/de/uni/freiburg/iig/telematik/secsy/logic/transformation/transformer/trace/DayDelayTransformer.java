...
public class DayDelayTransformer extends AbstractMultipleTraceTransformer<DayDelayTransformerProperties, DayDelayTransformer> {
     ...
     * Specifies the minimum number of days which are added to an entry's
     * timestamp .<br></li>
     * <li><code>Integer</code>: Max Days.<br>
     * Specifies the maximum number of days which are added to an entry's
     * timestamp .<br></li>
     * </ul>
     *
    ...
    @Override
    protected void fillProperties(DayDelayTransformerProperties properties) throws PropertyException {
        super.fillProperties(properties);
        properties.setDayBounds(getMinDays(), getMaxDays());
    }
    ...
    @Override
    protected DayDelayTransformerProperties newProperties() {
        return new DayDelayTransformerProperties();
    }
