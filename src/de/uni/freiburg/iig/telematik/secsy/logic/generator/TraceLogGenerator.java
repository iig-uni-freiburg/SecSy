...
/**
 * This class overrides the abstract class {@link LogGenerator}. It generates
 * logs in a trace oriented manner. Every log entry contains a complete
 * executions trace.
 *
...
public class TraceLogGenerator extends LogGenerator {
        ...
        protected void simulateNet(SimulationRun simulationRun) throws SimulationException, IOException {
                ...
                try {
                        while (!simulationRun.isDone()) {
                                ...
                                LogTrace<SimulationLogEntry> trace = new LogTrace<>(nextCaseID);
                                ...
                                while (!caseGenerator.isCaseCompleted()) {
                                        ...
                                        if (next != null && !next.isSilent()) {
                                                ...
                                                if (entry != null) {
                                                        ...
                                                        } catch (LockingException | InconsistencyException e) {
         ...
         * @param logEntry
         * @param executionTime
         * @throws LockingException If the time field of the given entry is
         * locked.
         */
