...
import de.uni.freiburg.iig.telematik.secsy.logic.transformation.transformer.trace.abstr.AbstractCustomTraceTransformer;
...
public class DesignatorTransformer extends AbstractCustomTraceTransformer<DesignatorTransformer> {
     ...
     * The first parameter is used for the transformer-property "minSize" and
     * must be a positive integer.<br>
     * The second parameter is used for the transformer-property "designator"
    ...
    @Override
    public void takeoverValues(DesignatorTransformer other) throws Exception {
        super.takeoverValues(other);
        // Take over values of custom fields
        setDesignator(other.getDesignator());
