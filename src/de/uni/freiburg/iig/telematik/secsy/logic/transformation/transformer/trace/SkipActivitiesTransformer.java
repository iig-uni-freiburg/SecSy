...
public class SkipActivitiesTransformer extends AbstractMultipleTraceTransformer<SkipActivitiesTransformerProperties, SkipActivitiesTransformer> {
    ...
    @Override
    protected void fillProperties(SkipActivitiesTransformerProperties properties) throws PropertyException {
    ...
    @Override
    protected SkipActivitiesTransformerProperties newProperties() {
        return new SkipActivitiesTransformerProperties();
    }
