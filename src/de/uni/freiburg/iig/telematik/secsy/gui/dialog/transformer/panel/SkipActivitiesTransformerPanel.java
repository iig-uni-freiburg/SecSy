...
public class SkipActivitiesTransformerPanel extends AbstractTransformerPanel<SkipActivitiesTransformer>{

	private static final long serialVersionUID = -2872611741024217976L;
	...
	public SkipActivitiesTransformerPanel(Set<String> activities) throws Exception {
		super(activities);
	}
	...
	protected void initialize() {
		...
		candidateActivities = getActivities();
		...
		if(btnAddSkipActivity == null){
			...
			btnAddSkipActivity.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					try {
						newSkipActivities = ValueChooserDialog.showDialog(SwingUtilities.getWindowAncestor(SkipActivitiesTransformerPanel.this), "Choose skip activities", skipActivityCandidates, ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
					} catch (Exception e1) {
						JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(SkipActivitiesTransformerPanel.this), "<html>Cannot launch value chooser dialog dialog.<br>Reason: " + e1.getMessage() + "</html>", "Internal Exception", JOptionPane.ERROR_MESSAGE);
					}
	...
	@Override
	public void initializeFields(SkipActivitiesTransformer transformer) throws Exception {
