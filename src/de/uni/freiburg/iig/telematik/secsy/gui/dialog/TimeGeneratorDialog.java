        ...
        if (btnOK == null) {
            ...
            btnOK.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    try{
                        generatorNames = SimulationComponents.getInstance().getContainerTimeGenerators().getComponentNames();
                    } catch(Exception ex){
                        ExceptionDialog.showException(TimeGeneratorDialog.this, "Internal Exception", new Exception("Cannot extract time generator names from simulation components", ex), true);
                    }
                    if (editMode) {
                        try {
    ...
    private JButton getSetActivityDurationsButton() {
        if (btnSetActivityDurations == null) {
            ...
            btnSetActivityDurations.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    try {
                        ActivityDDAllDialog.showDialog(TimeGeneratorDialog.this, DialogType.DURATION_DIALOG, TimeGeneratorDialog.this.activities, TimeGeneratorDialog.this.timeProperties);
                    } catch (ParameterException e1) {
    ...
    private JButton getSetActivityDelaysButton() {
        if (btnSetActivityDelays == null) {
            ...
            btnSetActivityDelays.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    try {
                        ActivityDDAllDialog.showDialog(TimeGeneratorDialog.this, DialogType.DELAY_DIALOG, TimeGeneratorDialog.this.activities, TimeGeneratorDialog.this.timeProperties);
                    } catch (ParameterException e1) {
