    ...
    private void setUpGUI(Window owner, Set<String> attributes) throws ParameterException {
        ...
        btnOK.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                Set<String> containerNames = null;
                try {
                    containerNames = new HashSet<String>(SimulationComponents.getInstance().getContainerCaseDataContainers().getComponentNames());
                } catch (Exception ex) {
                    ExceptionDialog.showException(DataContainerDialog.this, "Internal Exception", new Exception("Cannot extract case data container names", ex), true);
                }
