 ...
 */
public abstract class AbstractTraceFilter extends AbstractTransformer {
	 ...
	 */
	public AbstractTraceFilter(TransformerType filterType, double activationProbability) throws ParameterException{
	 ...
	 */
	public TraceTransformerResult filterLogTrace(TraceTransformerEvent event) throws ParameterException{
