...
public abstract class AbstractFilter {
	...
	public AbstractFilter(AbstractFilterProperties properties) throws ParameterException, PropertyException{
	...
	public AbstractFilter(FilterType filterType, double activationProbability) throws ParameterException{
	 ...
	 * {@link #addMessageToResult(String, AbstractFilterResult)}.
	 ...
	 */
	protected void addMessageToResult(String message, AbstractFilterResult result) throws ParameterException{
		Validate.notNull(result);
		if(includeMessages && message != null)
			result.addFilterMessage(message);
	}
