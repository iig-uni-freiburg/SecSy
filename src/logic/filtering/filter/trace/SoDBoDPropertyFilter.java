...
public abstract class SoDBoDPropertyFilter extends ActivityGroupPropertyEnforcementFilter {
	...
	public SoDBoDPropertyFilter(FilterType propertyType, Set<String>... bindings) throws ParameterException {
		this(propertyType, 0.0, bindings);
	}
	
	public SoDBoDPropertyFilter(FilterType propertyType, double violationProbability, Set<String>... bindings) throws ParameterException {
	...
	protected EnforcementResult findValidOriginatorCombination(Set<String> activityGroup,
															   List<LogEntry> allEntries,
			 												   ...
			 												   AbstractFilterResult filterResult, 
